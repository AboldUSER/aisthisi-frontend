  ...
  <Box my={10}>
    ...
    >
      ...
      <Box position="absolute" left="5%" right="5%" top='30%'>
        ...
        <Button component={Link} href='/#collection' variant="contained" style={{ cursor:'pointer', color: '#f8f9fa', backgroundColor: '#4691a0', fontWeight: 'bold', fontFamily: 'Titillium Web' }}>Show Collection</Button>
      </Box>
    </BackgroundImage>
  </Box>
);
